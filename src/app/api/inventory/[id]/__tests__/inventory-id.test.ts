...
describe('Inventory API - GET /api/inventory/[id]', () => {
  beforeEach(() => {
    vi.clearAllMocks();
  });
  ...
  it('should return inventory details with movements', async () => {
    ...
    const request = new NextRequest('http://localhost/api/inventory/inv-1');
  ...
  it('should return 404 if inventory not found', async () => {
    ...
    const request = new NextRequest('http://localhost/api/inventory/non-existent');
...
describe('Inventory API - PATCH /api/inventory/[id]', () => {
  beforeEach(() => {
    vi.clearAllMocks();
  });
...
describe('Inventory API - DELETE /api/inventory/[id]', () => {
  beforeEach(() => {
    vi.clearAllMocks();
  });
