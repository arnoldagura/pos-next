...
describe('Inventory API - GET /api/product-inventory/movements', () => {
  beforeEach(() => {
    vi.clearAllMocks();
  });
  ...
  it('should return movements list', async () => {
    ...
    const request = new NextRequest(
      'http://localhost/api/product-inventory/movements?page=1&limit=50'
    );
  ...
  it('should filter by inventoryId', async () => {
    ...
    const request = new NextRequest(
      'http://localhost/api/product-inventory/movements?inventoryId=inv-1'
    );
    const response = await getMovementsHandler(request);
  ...
  it('should filter by type', async () => {
    ...
    const request = new NextRequest(
      'http://localhost/api/product-inventory/movements?type=purchase'
    );
    const response = await getMovementsHandler(request);
  ...
  it('should filter by date range', async () => {
    ...
    const request = new NextRequest(
      'http://localhost/api/product-inventory/movements?startDate=2024-01-01&endDate=2024-12-31'
    );
    const response = await getMovementsHandler(request);
