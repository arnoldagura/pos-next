  ...
  const fetchMovements = async () => {
    try {
      ...
      const response = await fetch(
        `/api/inventory/${inventoryId}/movements?${params}`
      );
      ...
      {inventoryDetails && (
        <div>
          ...
          <p className="text-muted-foreground">
            ...
            {inventoryDetails.productSku &&
              ` • SKU: ${inventoryDetails.productSku}`}
          </p>
        </div>
      )}
      ...
      <div className="flex flex-col sm:flex-row gap-4 items-start sm:items-center justify-between">
        <Select value={typeFilter} onValueChange={setTypeFilter}>
          ...
          <SelectContent>
            ...
            <SelectItem value="receive_from_material">
              Receive from Material
            </SelectItem>
          </SelectContent>
        </Select>
      </div>
                ...
                <TableBody>
                  {movements.map((movement) => {
                    ...
                    const unitPrice = movement.unitPrice
                      ...
                      : null;
                    const totalValue =
                      unitPrice !== null ? Math.abs(quantity) * unitPrice : null;
